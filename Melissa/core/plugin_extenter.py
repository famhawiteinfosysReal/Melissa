...
from Melissa import custom_plugins, internal_plugins, plugin, plugins, util
from Melissa.error import ExistingPluginError
...
class PluginExtender(MixinBase):
    ...
    def load_plugin(
        self: "Melissa", cls: Type[plugin.Plugin], *, comment: Optional[str] = None
    ) -> None:
    ...
    def unload_plugin(self: "Melissa", plug: plugin.Plugin) -> None:
        cls = type(plug)
    ...
    def _load_all_from_metaplug(
        self: "Melissa", subplugins: Iterable[PluginType], *, comment: Optional[str] = None
    ) -> None:
    ...
    def load_all_plugins(self: "Melissa") -> None:
    ...
    def unload_all_plugins(self: "Melissa") -> None:
    ...
    async def reload_plugin_pkg(self: "Melissa") -> None:
