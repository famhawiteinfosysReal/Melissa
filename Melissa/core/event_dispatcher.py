...
from Melissa import plugin, util
from Melissa.error import EventDispatchError
from Melissa.listener import Listener, ListenerFunc
...
class EventDispatcher(MixinBase):
    ...
    def unregister_listener(self: "Melissa", listener: Listener) -> None:
    ...
    def register_listeners(self: "Melissa", plug: plugin.Plugin) -> None:
    ...
    def unregister_listeners(self: "Melissa", plug: plugin.Plugin) -> None:
    ...
    async def dispatch_missed_events(self: "Melissa") -> None:
