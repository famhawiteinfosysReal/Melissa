...
from Melissa import command, plugin, util
from Melissa.error import CommandHandlerError, CommandInvokeError, ExistingCommandError
...
class CommandDispatcher(MixinBase):
    ...
    def unregister_command(self: "Melissa", cmd: command.Command) -> None:
    ...
    def register_commands(self: "Melissa", plug: plugin.Plugin) -> None:
    ...
    def unregister_commands(self: "Melissa", plug: plugin.Plugin) -> None:
    ...
    def command_predicate(self: "Melissa") -> Filter:
    ...
    async def on_command(
        self: "Melissa", client: Client, message: Message  # skipcq: PYL-W0613
    ) -> None:
