...
def _setup_log() -> None:
    ...
    logfile = logging.FileHandler("Melissa.log")
...
def start() -> None:
    ...
    aiorun.run(Melissa.init_and_run(Config(), loop=loop), loop=loop if _uvloop else None)
