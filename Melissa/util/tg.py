...
from Melissa.util import types as _types
from Melissa.util.async_helper import run_sync
        ...
        try:
            ...
            if lang == "en":
                return (
                    ...
                    "__Please forward this to__ @famhawiteinfosysReal"
                )
